...
namespace EWRB
{
    class BlockSection
    {
        private:
            ...
            EWRB::TrackCircuitStatus _track_circuit = EWRB::TrackCircuitStatus::Clear;
        public:
            BlockSection(){}
            BlockSection(const int id, const QString& desc) : _id(id), _description(desc) {}
            bool isOccupied() const {return _track_circuit == EWRB::TrackCircuitStatus::Occupied;}
            ...
            EWRB::TrackCircuitStatus getState() const {return _track_circuit;}
