...
void ERMainWindow::_add_signals()
{
    ...
    _signals[4] = new EWRB::Signal(3);                                      // Platform 4 Approach SIG. 4
    ...
    _block_sections[5]->setBlockSignal(_signals[7]);                        // Westbound Starter Platform 2 SIG. 5
    ...
    _block_sections[6]->setBlockSignal(_signals[4]);                        // Westbound Starter Platform 3 SIG. 6
    ...
    _block_sections[7]->setBlockSignal(_signals[6]);                        // Westbound Starter Platform 4 SIG. 7
    ...
    _block_sections[36]->setRequiredState(EWRB::SignalState::Off);           // Disc 2AT Signal
    ...
    _block_sections[37]->setRequiredState(EWRB::SignalState::Off);           // Disc 2AT Signal
    ...
    _block_sections[38]->setRequiredState(EWRB::SignalState::Off);           // Disc 2AT Signal
